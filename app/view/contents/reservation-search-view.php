            ...
            <div class="row justify-content-md-center">
                <div class="col-12 col-md-4">
                    <div class="form-group">
                        ...
                        <input type="date" class="form-control" name="busqueda_fecha_inicial" id="busqueda_inicio_prestamo" maxlength="30">
                    </div>
                </div>
                <div class="col-12 col-md-4">
                    <div class="form-group">
                        <label for="busqueda_final_prestamo" >Fecha final (día/mes/año)</label>
                        <input type="date" class="form-control" name="busqueda_fecha_final" id="busqueda_final_prestamo" maxlength="30">
                    </div>
                </div>
                <div class="col-12">
